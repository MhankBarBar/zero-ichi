...
export const api = {
  ...
  getWelcome: (groupId: string) =>
    fetchAPI<WelcomeConfig>(`/api/groups/${groupId}/welcome`),
  updateWelcome: (groupId: string, config: WelcomeConfig) =>
    fetchAPI(`/api/groups/${groupId}/welcome`, {
      method: "PUT",
      body: JSON.stringify(config),
    }),
  getGoodbye: (groupId: string) =>
    fetchAPI<WelcomeConfig>(`/api/groups/${groupId}/goodbye`),
  ...
  getTasks: () =>
    fetchAPI<{ tasks: ScheduledTask[]; count: number }>("/api/tasks"),
  ...
  getNotes: (groupId: string) =>
    fetchAPI<{ notes: Note[]; count: number }>(`/api/groups/${encodeURIComponent(groupId)}/notes`),
  ...
  updateNote: (groupId: string, noteName: string, content: string, mediaType?: string) =>
    fetchAPI(`/api/groups/${encodeURIComponent(groupId)}/notes/${encodeURIComponent(noteName)}`, {
      method: "PUT",
  ...
  getFilters: (groupId: string) =>
    fetchAPI<{ filters: Filter[]; count: number }>(`/api/groups/${encodeURIComponent(groupId)}/filters`),
  ...
  deleteFilter: (groupId: string, trigger: string) =>
    fetchAPI(`/api/groups/${encodeURIComponent(groupId)}/filters/${encodeURIComponent(trigger)}`, {
      method: "DELETE",
    }),

  getBlacklist: (groupId: string) =>
    fetchAPI<{ words: string[]; count: number }>(`/api/groups/${encodeURIComponent(groupId)}/blacklist`),
  ...
  removeBlacklistWord: (groupId: string, word: string) =>
    fetchAPI(`/api/groups/${encodeURIComponent(groupId)}/blacklist/${encodeURIComponent(word)}`, {
      method: "DELETE",
    }),
